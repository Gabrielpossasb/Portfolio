         ...
         <div className="relative overflow-hidden pb-20">
            <ContainerHome >
               <div className="welcome" >           
                  ...
                  <div className="p-10 py-16 flex flex-col gap-4 z-20 rounded-3xl text-white bg-gradient-to-b from-purple-600/30 via-purple-500/30 to-cyan-600/30 shadow-boxLg">
